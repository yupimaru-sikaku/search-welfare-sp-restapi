# Generated by Django 3.1 on 2022-02-13 06:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serviceType', models.CharField(choices=[('共同生活援助（介護サービス包括型）', '共同生活援助（介護サービス包括型）'), ('就労継続支援B型', '就労継続支援B型'), ('生活介護', '生活介護'), ('計画相談支援', '計画相談支援'), ('重度訪問介護', '重度訪問介護'), ('児童発達支援', '児童発達支援'), ('計画相談支援', '計画相談支援'), ('障がい児相談支援', '障がい児相談支援')], default='共同生活援助（介護サービス包括型）', max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
